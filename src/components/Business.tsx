    ...
    <div className='business'>
      ...
      <div className='business-content'>
        <div className='cloud'>
            ...
            <div>Put your business ahead of the competition with technology and the latest online services</div>
            <div>Simple, Transparent and Honest</div>
        ...
        <div>Collect payments easily with no time limitation through M-PESA</div>
                  <div>Simple, Transparent and Honest</div>
              ...
              <div className='shiriki'>
                  ...
                  <div>Get affordable internet and calling rates for your small or medium sized business</div>
                  <div>Simple, Transparent and Honest</div>
                  <button className='buttons'>M-PESA business till</button>
              </div>
      </div>
